	...
	return []domain.Skill{
		{
			...
			Category:    "Cases", TierCount: 3, XPPerTier: 120, SortOrder: skillOrder(10),
		},
		{
			...
			Category:    "Cases", TierCount: 3, XPPerTier: 120, SortOrder: skillOrder(20),
		},
		{
			SkillID: "el-case-genitive", Language: "el", Name: "Genitive Case",
			Description: "Read possession and common genitive complements.",
			Category:    "Cases", TierCount: 3, XPPerTier: 140, SortOrder: skillOrder(30),
		},
		{
			...
			Category:    "Verb Forms", TierCount: 3, XPPerTier: 100, SortOrder: skillOrder(10),
		},
		{
			SkillID: "el-verb-future-tha", Language: "el", Name: "θα Future",
			Description: "Recognize future meaning with θα plus a verb form.",
			Category:    "Verb Forms", TierCount: 3, XPPerTier: 110, SortOrder: skillOrder(20),
		},
		{
			...
			Category:    "Verb Forms", TierCount: 3, XPPerTier: 160, SortOrder: skillOrder(30),
		},
		{
			SkillID: "el-construction-na", Language: "el", Name: "να Clauses",
			Description: "Read purpose, desire, and soft command clauses with να.",
			Category:    "Constructions", TierCount: 3, XPPerTier: 130, SortOrder: skillOrder(10),
		},
		{
			...
			Category:    "Constructions", TierCount: 3, XPPerTier: 90, SortOrder: skillOrder(20),
		},
		{
			...
			Category:    "Vocabulary", TierCount: 3, XPPerTier: 100, SortOrder: skillOrder(10),
		},
		{
			...
			Category:    "Vocabulary", TierCount: 3, XPPerTier: 100, SortOrder: skillOrder(20),
		},
		{
			...
			Category:    "Pragmatics", TierCount: 3, XPPerTier: 80, SortOrder: skillOrder(10),
		},
		{
			...
			Category:    "Pragmatics", TierCount: 3, XPPerTier: 120, SortOrder: skillOrder(20),
		},
	}
}
