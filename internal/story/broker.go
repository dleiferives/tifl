...
func (b *Broker) RunTaskRegeneration(ctx context.Context, reportID, taskID, userID string, finalAttempt bool) error {
	return b.pipeline.RegenerateTaskAttempt(ctx, reportID, taskID, userID, finalAttempt)
}
